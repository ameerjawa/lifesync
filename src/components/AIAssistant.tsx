...
import { ChatView } from './ai/views/ChatView';
import { InsightsView } from './ai/views/InsightsView';
import { ScheduleView } from './ai/views/ScheduleView';
import { HelpView } from './ai/views/HelpView';
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-20 right-4 z-50 w-96 rounded-lg bg-white shadow-xl"
          >
            <AIHeader />
